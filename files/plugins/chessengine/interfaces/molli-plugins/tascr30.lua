...
interface.strength = "expert"
interface.style = "normal"
interface.easy = "off"
interface.cur_level = nil
interface.cur_option = nil
interface.cur_style = nil
interface.cur_strength = nil
interface.cur_easy = nil
interface.cur_option = nil 

function interface.init_options()
-- Reset internal values : important!!!!

    if interface.cur_option == nil then
        send_input(":IN.2", 0x20, 0.5) -- Menu
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
    ...
    interface.cur_option = "init"
end

function interface.seteasy()
    if (interface.cur_easy == nil or interface.cur_easy == interface.easy) then
        return
    end
    interface.cur_easy = interface.easy
    ...
    send_input(":IN.1", 0x40, 0.5) -- right
    send_input(":IN.1", 0x40, 0.5) -- right
    if interface.easy == "on" then
        send_input(":IN.3", 0x20, 0.5) -- enter
    else
    -- off
        send_input(":IN.2", 0x40, 0.5) -- up
        send_input(":IN.3", 0x20, 0.5) -- enter
    end
    send_input(":IN.2", 0x20, 0.5) -- Menu
end
...
function interface.setstyle()
    ...
    if interface.style == "defensive" then
        send_input(":IN.2", 0x40, 0.5) -- up
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.style == "solid" then
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.style == "normal" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.style == "active" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.style == "offensive" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
...
function interface.setstrength()
    if (interface.cur_strength == nil or interface.cur_strength == interface.strength) then
        return
    end
    interface.cur_strength = interface.strength
    ...
    if interface.strength == "expert" then
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.strength == "strong" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.strength == "moderate" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
    elseif interface.strength == "novice" then
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x40, 0.5) -- down
        send_input(":IN.3", 0x20, 0.5) -- enter
...
function interface.setup_machine()
    ...
    interface.cur_style = ""
    interface.setstyle()
    interface.cur_strength = ""
    interface.setstrength()
end
...
function interface.get_options()
    return { { "string", "Level", "40/2:00 moves/hrs"}, { "string", "style", "normal"}, { "string", "strength", "expert"}, {"string", "easy", "off"}, }
end
...
function interface.set_option(name, value)
   ...
   if (name == "style" and value ~= "") then
       interface.style = value
       interface.setstyle()
   end

   if (name == "strength" and value ~= "") then
       interface.strength = value
       interface.setstrength()
   end

   if (name == "easy" and value ~= "") then
       interface.easy = value
       interface.seteasy()
   end
